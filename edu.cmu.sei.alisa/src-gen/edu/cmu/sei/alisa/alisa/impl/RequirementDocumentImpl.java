 ...
 * @generated
 */
public class RequirementDocumentImpl extends AlisaElementImpl implements RequirementDocument
{
  /**
  ...
  public EList<EObject> getContent()
  {
    if (content == null)
    {
      content = new EObjectContainmentEList<EObject>(EObject.class, this, AlisaPackage.REQUIREMENT_DOCUMENT__CONTENT);
    }
    return content;
  }
