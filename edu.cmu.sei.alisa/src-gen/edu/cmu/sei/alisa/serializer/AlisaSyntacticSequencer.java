...
public class AlisaSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_Requirement___VerifiedKeyword_2_13_0_ByKeyword_2_13_1__a;
	protected AbstractElementAlias match_Requirement___VerifiedKeyword_2_13_0_ByKeyword_2_13_1__p;
	...
	protected void init(IGrammarAccess access) {
		...
		match_Requirement___VerifiedKeyword_2_13_0_ByKeyword_2_13_1__a = new GroupAlias(true, true, new TokenAlias(false, false, grammarAccess.getRequirementAccess().getVerifiedKeyword_2_13_0()), new TokenAlias(false, false, grammarAccess.getRequirementAccess().getByKeyword_2_13_1()));
		match_Requirement___VerifiedKeyword_2_13_0_ByKeyword_2_13_1__p = new GroupAlias(true, false, new TokenAlias(false, false, grammarAccess.getRequirementAccess().getVerifiedKeyword_2_13_0()), new TokenAlias(false, false, grammarAccess.getRequirementAccess().getByKeyword_2_13_1()));
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			if(match_Requirement___VerifiedKeyword_2_13_0_ByKeyword_2_13_1__a.equals(syntax))
				emit_Requirement___VerifiedKeyword_2_13_0_ByKeyword_2_13_1__a(semanticObject, getLastNavigableState(), syntaxNodes);
			else if(match_Requirement___VerifiedKeyword_2_13_0_ByKeyword_2_13_1__p.equals(syntax))
				emit_Requirement___VerifiedKeyword_2_13_0_ByKeyword_2_13_1__p(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *     ('verified' 'by')*
	 */
	protected void emit_Requirement___VerifiedKeyword_2_13_0_ByKeyword_2_13_1__a(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
	 ...
	 *     ('verified' 'by')+
	 */
	protected void emit_Requirement___VerifiedKeyword_2_13_0_ByKeyword_2_13_1__p(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
