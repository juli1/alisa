		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getGoalAccess().getGroup_12_5(), "rule__Goal__Group_12_5__0");
					put(grammarAccess.getGoalAccess().getGroup_13(), "rule__Goal__Group_13__0");
					put(grammarAccess.getGoalAccess().getGroup_13_4(), "rule__Goal__Group_13_4__0");
					...
					put(grammarAccess.getReqSpecAccess().getGroup_14_5(), "rule__ReqSpec__Group_14_5__0");
					...
					put(grammarAccess.getReqSpecAccess().getGroup_16_4(), "rule__ReqSpec__Group_16_4__0");
					...
					put(grammarAccess.getGoalsAccess().getFqnAssignment_1(), "rule__Goals__FqnAssignment_1");
					...
					put(grammarAccess.getGoalAccess().getFqnAssignment_1(), "rule__Goal__FqnAssignment_1");
					...
					put(grammarAccess.getGoalAccess().getStakeholderReferenceAssignment_12_4(), "rule__Goal__StakeholderReferenceAssignment_12_4");
					put(grammarAccess.getGoalAccess().getStakeholderReferenceAssignment_12_5_1(), "rule__Goal__StakeholderReferenceAssignment_12_5_1");
					put(grammarAccess.getGoalAccess().getDocReferencesAssignment_13_3(), "rule__Goal__DocReferencesAssignment_13_3");
					put(grammarAccess.getGoalAccess().getDocReferencesAssignment_13_4_1(), "rule__Goal__DocReferencesAssignment_13_4_1");
					put(grammarAccess.getReqSpecificationsAccess().getFqnAssignment_1(), "rule__ReqSpecifications__FqnAssignment_1");
					...
					put(grammarAccess.getReqSpecAccess().getFqnAssignment_1(), "rule__ReqSpec__FqnAssignment_1");
					put(grammarAccess.getReqSpecAccess().getReqTargetAssignment_2_1(), "rule__ReqSpec__ReqTargetAssignment_2_1");
					...
					put(grammarAccess.getReqSpecAccess().getStakeholderreqReferenceAssignment_14_4(), "rule__ReqSpec__StakeholderreqReferenceAssignment_14_4");
					put(grammarAccess.getReqSpecAccess().getStakeholderreqReferenceAssignment_14_5_1(), "rule__ReqSpec__StakeholderreqReferenceAssignment_14_5_1");
					put(grammarAccess.getReqSpecAccess().getSystemreqReferenceAssignment_15_4(), "rule__ReqSpec__SystemreqReferenceAssignment_15_4");
					put(grammarAccess.getReqSpecAccess().getSystemreqReferenceAssignment_15_5_1(), "rule__ReqSpec__SystemreqReferenceAssignment_15_5_1");
					put(grammarAccess.getReqSpecAccess().getDocReferencesAssignment_16_3(), "rule__ReqSpec__DocReferencesAssignment_16_3");
					put(grammarAccess.getReqSpecAccess().getDocReferencesAssignment_16_4_1(), "rule__ReqSpec__DocReferencesAssignment_16_4_1");
					put(grammarAccess.getExternalDocumentsAccess().getFqnAssignment_1(), "rule__ExternalDocuments__FqnAssignment_1");
					...
					put(grammarAccess.getExternalDocumentAccess().getFqnAssignment_1(), "rule__ExternalDocument__FqnAssignment_1");
