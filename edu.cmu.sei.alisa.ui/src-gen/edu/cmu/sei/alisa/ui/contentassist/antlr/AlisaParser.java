		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getRequirementDocumentAccess().getGroup_2(), "rule__RequirementDocument__Group_2__0");
					...
					put(grammarAccess.getGoalAccess().getGroup_10_5(), "rule__Goal__Group_10_5__0");
					put(grammarAccess.getGoalAccess().getGroup_11(), "rule__Goal__Group_11__0");
					put(grammarAccess.getGoalAccess().getGroup_11_4(), "rule__Goal__Group_11_4__0");
					...
					put(grammarAccess.getReqSpecAccess().getGroup_8_4(), "rule__ReqSpec__Group_8_4__0");
					...
					put(grammarAccess.getReqSpecAccess().getGroup_10_3(), "rule__ReqSpec__Group_10_3__0");
					...
					put(grammarAccess.getReqSpecAccess().getGroup_12_5(), "rule__ReqSpec__Group_12_5__0");
					put(grammarAccess.getReqSpecAccess().getGroup_13(), "rule__ReqSpec__Group_13__0");
					put(grammarAccess.getReqSpecAccess().getGroup_13_5(), "rule__ReqSpec__Group_13_5__0");
					put(grammarAccess.getReqSpecAccess().getGroup_14(), "rule__ReqSpec__Group_14__0");
					put(grammarAccess.getReqSpecAccess().getGroup_14_4(), "rule__ReqSpec__Group_14_4__0");
					...
					put(grammarAccess.getRequirementDocumentAccess().getNameAssignment_1(), "rule__RequirementDocument__NameAssignment_1");
					put(grammarAccess.getRequirementDocumentAccess().getStakeholdersAssignment_2_1(), "rule__RequirementDocument__StakeholdersAssignment_2_1");
					put(grammarAccess.getRequirementDocumentAccess().getRequirementsAssignment_4(), "rule__RequirementDocument__RequirementsAssignment_4");
					...
					put(grammarAccess.getGoalAccess().getModelReferenceAssignment_7_2(), "rule__Goal__ModelReferenceAssignment_7_2");
					put(grammarAccess.getGoalAccess().getModelReferenceAssignment_7_3_1(), "rule__Goal__ModelReferenceAssignment_7_3_1");
					put(grammarAccess.getGoalAccess().getRefinesReferenceAssignment_8_2(), "rule__Goal__RefinesReferenceAssignment_8_2");
					put(grammarAccess.getGoalAccess().getRefinesReferenceAssignment_8_3_1(), "rule__Goal__RefinesReferenceAssignment_8_3_1");
					put(grammarAccess.getGoalAccess().getDecomposesReferenceAssignment_9_2(), "rule__Goal__DecomposesReferenceAssignment_9_2");
					put(grammarAccess.getGoalAccess().getDecomposesReferenceAssignment_9_3_1(), "rule__Goal__DecomposesReferenceAssignment_9_3_1");
					put(grammarAccess.getGoalAccess().getStakeholderReferenceAssignment_10_4(), "rule__Goal__StakeholderReferenceAssignment_10_4");
					put(grammarAccess.getGoalAccess().getStakeholderReferenceAssignment_10_5_1(), "rule__Goal__StakeholderReferenceAssignment_10_5_1");
					put(grammarAccess.getGoalAccess().getDocReferencesAssignment_11_3(), "rule__Goal__DocReferencesAssignment_11_3");
					put(grammarAccess.getGoalAccess().getDocReferencesAssignment_11_4_1(), "rule__Goal__DocReferencesAssignment_11_4_1");
					...
					put(grammarAccess.getReqSpecAccess().getModelReferenceAssignment_7_2(), "rule__ReqSpec__ModelReferenceAssignment_7_2");
					put(grammarAccess.getReqSpecAccess().getModelReferenceAssignment_7_3_1(), "rule__ReqSpec__ModelReferenceAssignment_7_3_1");
					put(grammarAccess.getReqSpecAccess().getGoalReferenceAssignment_8_3(), "rule__ReqSpec__GoalReferenceAssignment_8_3");
					put(grammarAccess.getReqSpecAccess().getGoalReferenceAssignment_8_4_1(), "rule__ReqSpec__GoalReferenceAssignment_8_4_1");
					put(grammarAccess.getReqSpecAccess().getHazardReferenceAssignment_9_3(), "rule__ReqSpec__HazardReferenceAssignment_9_3");
					put(grammarAccess.getReqSpecAccess().getHazardReferenceAssignment_9_4_1(), "rule__ReqSpec__HazardReferenceAssignment_9_4_1");
					put(grammarAccess.getReqSpecAccess().getRefinesReferenceAssignment_10_2(), "rule__ReqSpec__RefinesReferenceAssignment_10_2");
					put(grammarAccess.getReqSpecAccess().getRefinesReferenceAssignment_10_3_1(), "rule__ReqSpec__RefinesReferenceAssignment_10_3_1");
					put(grammarAccess.getReqSpecAccess().getDecomposesReferenceAssignment_11_2(), "rule__ReqSpec__DecomposesReferenceAssignment_11_2");
					put(grammarAccess.getReqSpecAccess().getDecomposesReferenceAssignment_11_3_1(), "rule__ReqSpec__DecomposesReferenceAssignment_11_3_1");
					put(grammarAccess.getReqSpecAccess().getStakeholderreqReferenceAssignment_12_4(), "rule__ReqSpec__StakeholderreqReferenceAssignment_12_4");
					put(grammarAccess.getReqSpecAccess().getStakeholderreqReferenceAssignment_12_5_1(), "rule__ReqSpec__StakeholderreqReferenceAssignment_12_5_1");
					put(grammarAccess.getReqSpecAccess().getSystemreqReferenceAssignment_13_4(), "rule__ReqSpec__SystemreqReferenceAssignment_13_4");
					put(grammarAccess.getReqSpecAccess().getSystemreqReferenceAssignment_13_5_1(), "rule__ReqSpec__SystemreqReferenceAssignment_13_5_1");
					put(grammarAccess.getReqSpecAccess().getDocReferencesAssignment_14_3(), "rule__ReqSpec__DocReferencesAssignment_14_3");
					put(grammarAccess.getReqSpecAccess().getDocReferencesAssignment_14_4_1(), "rule__ReqSpec__DocReferencesAssignment_14_4_1");
