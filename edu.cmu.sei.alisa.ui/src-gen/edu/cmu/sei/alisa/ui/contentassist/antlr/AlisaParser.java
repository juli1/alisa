		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getContractualElementAccess().getGroup_2_13_3(), "rule__ContractualElement__Group_2_13_3__0");
					put(grammarAccess.getContractualElementAccess().getGroup_2_14(), "rule__ContractualElement__Group_2_14__0");
					put(grammarAccess.getContractualElementAccess().getGroup_2_14_3(), "rule__ContractualElement__Group_2_14_3__0");
					...
					put(grammarAccess.getAssumptionAccess().getGroup_2_0(), "rule__Assumption__Group_2_0__0");
					put(grammarAccess.getAssumptionAccess().getGroup_2_1(), "rule__Assumption__Group_2_1__0");
					put(grammarAccess.getAssumptionAccess().getGroup_2_1_2(), "rule__Assumption__Group_2_1_2__0");
					put(grammarAccess.getAssumptionAccess().getGroup_2_2(), "rule__Assumption__Group_2_2__0");
					put(grammarAccess.getAssumptionAccess().getGroup_2_3(), "rule__Assumption__Group_2_3__0");
					put(grammarAccess.getAssumptionAccess().getGroup_2_4(), "rule__Assumption__Group_2_4__0");
					put(grammarAccess.getAssumptionAccess().getGroup_2_5(), "rule__Assumption__Group_2_5__0");
					put(grammarAccess.getAssumptionAccess().getGroup_2_6(), "rule__Assumption__Group_2_6__0");
					put(grammarAccess.getAssumptionAccess().getGroup_2_6_2(), "rule__Assumption__Group_2_6_2__0");
					...
					put(grammarAccess.getVerificationActivityAccess().getGroup_3_4(), "rule__VerificationActivity__Group_3_4__0");
					...
					put(grammarAccess.getContractualElementAccess().getStakeholderRequirementReferenceAssignment_2_13_2(), "rule__ContractualElement__StakeholderRequirementReferenceAssignment_2_13_2");
					put(grammarAccess.getContractualElementAccess().getStakeholderRequirementReferenceAssignment_2_13_3_1(), "rule__ContractualElement__StakeholderRequirementReferenceAssignment_2_13_3_1");
					put(grammarAccess.getContractualElementAccess().getSystemRequirementReferenceAssignment_2_14_2(), "rule__ContractualElement__SystemRequirementReferenceAssignment_2_14_2");
					put(grammarAccess.getContractualElementAccess().getSystemRequirementReferenceAssignment_2_14_3_1(), "rule__ContractualElement__SystemRequirementReferenceAssignment_2_14_3_1");
					...
					put(grammarAccess.getAssumptionAccess().getNameAssignment_1(), "rule__Assumption__NameAssignment_1");
					put(grammarAccess.getAssumptionAccess().getTargetAssignment_2_0_1(), "rule__Assumption__TargetAssignment_2_0_1");
					put(grammarAccess.getAssumptionAccess().getCategoryAssignment_2_1_1(), "rule__Assumption__CategoryAssignment_2_1_1");
					put(grammarAccess.getAssumptionAccess().getCategoryAssignment_2_1_2_1(), "rule__Assumption__CategoryAssignment_2_1_2_1");
					put(grammarAccess.getAssumptionAccess().getTitleAssignment_2_2_1(), "rule__Assumption__TitleAssignment_2_2_1");
					put(grammarAccess.getAssumptionAccess().getDescriptionAssignment_2_3_1(), "rule__Assumption__DescriptionAssignment_2_3_1");
					put(grammarAccess.getAssumptionAccess().getAssertAssignment_2_4_1(), "rule__Assumption__AssertAssignment_2_4_1");
					put(grammarAccess.getAssumptionAccess().getRationaleAssignment_2_5_1(), "rule__Assumption__RationaleAssignment_2_5_1");
					put(grammarAccess.getAssumptionAccess().getIssueAssignment_2_6_1(), "rule__Assumption__IssueAssignment_2_6_1");
					put(grammarAccess.getAssumptionAccess().getIssueAssignment_2_6_2_1(), "rule__Assumption__IssueAssignment_2_6_2_1");
					put(grammarAccess.getAssumptionAccess().getVerifiedByAssignment_2_7(), "rule__Assumption__VerifiedByAssignment_2_7");
					...
					put(grammarAccess.getVerificationActivityAccess().getAssumptionAssignment_3_4_1(), "rule__VerificationActivity__AssumptionAssignment_3_4_1");
					...
					put(grammarAccess.getClaimResultAccess().getPassCountAssignment_5_1(), "rule__ClaimResult__PassCountAssignment_5_1");
					...
					put(grammarAccess.getClaimResultAccess().getSubClaimResultAssignment_9(), "rule__ClaimResult__SubClaimResultAssignment_9");
					put(grammarAccess.getClaimResultAccess().getSubVAResultAssignment_10(), "rule__ClaimResult__SubVAResultAssignment_10");
					...
					put(grammarAccess.getAssumptionAccess().getUnorderedGroup_2(), "rule__Assumption__UnorderedGroup_2");
