		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getRSALContainerAccess().getContentAlternatives_3_0(), "rule__RSALContainer__ContentAlternatives_3_0");
					...
					put(grammarAccess.getRSALContainerAccess().getGroup_4(), "rule__RSALContainer__Group_4__0");
					put(grammarAccess.getRSALContainerAccess().getGroup_4_2(), "rule__RSALContainer__Group_4_2__0");
					...
					put(grammarAccess.getGoalAccess().getGroup_2_16(), "rule__Goal__Group_2_16__0");
					put(grammarAccess.getGoalAccess().getGroup_2_16_2(), "rule__Goal__Group_2_16_2__0");
					...
					put(grammarAccess.getRequirementAccess().getGroup_2_13_2(), "rule__Requirement__Group_2_13_2__0");
					put(grammarAccess.getRequirementAccess().getGroup_2_14(), "rule__Requirement__Group_2_14__0");
					put(grammarAccess.getRequirementAccess().getGroup_2_14_3(), "rule__Requirement__Group_2_14_3__0");
					...
					put(grammarAccess.getRequirementAccess().getGroup_2_18(), "rule__Requirement__Group_2_18__0");
					put(grammarAccess.getRequirementAccess().getGroup_2_18_3(), "rule__Requirement__Group_2_18_3__0");
					put(grammarAccess.getRequirementAccess().getGroup_2_19(), "rule__Requirement__Group_2_19__0");
					put(grammarAccess.getRequirementAccess().getGroup_2_19_2(), "rule__Requirement__Group_2_19_2__0");
					...
					put(grammarAccess.getHazardAccess().getGroup_2_0(), "rule__Hazard__Group_2_0__0");
					put(grammarAccess.getHazardAccess().getGroup_2_1(), "rule__Hazard__Group_2_1__0");
					put(grammarAccess.getHazardAccess().getGroup_2_1_2(), "rule__Hazard__Group_2_1_2__0");
					put(grammarAccess.getHazardAccess().getGroup_2_2(), "rule__Hazard__Group_2_2__0");
					put(grammarAccess.getHazardAccess().getGroup_2_3(), "rule__Hazard__Group_2_3__0");
					put(grammarAccess.getHazardAccess().getGroup_2_4(), "rule__Hazard__Group_2_4__0");
					put(grammarAccess.getHazardAccess().getGroup_2_5(), "rule__Hazard__Group_2_5__0");
					put(grammarAccess.getHazardAccess().getGroup_2_6(), "rule__Hazard__Group_2_6__0");
					put(grammarAccess.getHazardAccess().getGroup_2_6_2(), "rule__Hazard__Group_2_6_2__0");
					...
					put(grammarAccess.getRSALContainerAccess().getContentAssignment_3(), "rule__RSALContainer__ContentAssignment_3");
					put(grammarAccess.getRSALContainerAccess().getIssueAssignment_4_1(), "rule__RSALContainer__IssueAssignment_4_1");
					put(grammarAccess.getRSALContainerAccess().getIssueAssignment_4_2_1(), "rule__RSALContainer__IssueAssignment_4_2_1");
					...
					put(grammarAccess.getRSALVariableAccess().getNameAssignment_1(), "rule__RSALVariable__NameAssignment_1");
					put(grammarAccess.getRSALVariableAccess().getValueAssignment_3(), "rule__RSALVariable__ValueAssignment_3");
					...
					put(grammarAccess.getGoalAccess().getRefinesReferenceAssignment_2_7_2(), "rule__Goal__RefinesReferenceAssignment_2_7_2");
					put(grammarAccess.getGoalAccess().getRefinesReferenceAssignment_2_7_3_1(), "rule__Goal__RefinesReferenceAssignment_2_7_3_1");
					put(grammarAccess.getGoalAccess().getSubgoalAssignment_2_8(), "rule__Goal__SubgoalAssignment_2_8");
					...
					put(grammarAccess.getGoalAccess().getStakeholderRequirementReferenceAssignment_2_13_2(), "rule__Goal__StakeholderRequirementReferenceAssignment_2_13_2");
					put(grammarAccess.getGoalAccess().getStakeholderRequirementReferenceAssignment_2_13_3_1(), "rule__Goal__StakeholderRequirementReferenceAssignment_2_13_3_1");
					put(grammarAccess.getGoalAccess().getSystemRequirementReferenceAssignment_2_14_2(), "rule__Goal__SystemRequirementReferenceAssignment_2_14_2");
					put(grammarAccess.getGoalAccess().getSystemRequirementReferenceAssignment_2_14_3_1(), "rule__Goal__SystemRequirementReferenceAssignment_2_14_3_1");
					...
					put(grammarAccess.getGoalAccess().getModelReferenceAssignment_2_16_1(), "rule__Goal__ModelReferenceAssignment_2_16_1");
					put(grammarAccess.getGoalAccess().getModelReferenceAssignment_2_16_2_1(), "rule__Goal__ModelReferenceAssignment_2_16_2_1");
					...
					put(grammarAccess.getRequirementAccess().getReqValueAssignment_2_6(), "rule__Requirement__ReqValueAssignment_2_6");
					put(grammarAccess.getRequirementAccess().getIssueAssignment_2_7_1(), "rule__Requirement__IssueAssignment_2_7_1");
					put(grammarAccess.getRequirementAccess().getIssueAssignment_2_7_2_1(), "rule__Requirement__IssueAssignment_2_7_2_1");
					...
					put(grammarAccess.getRequirementAccess().getSubrequirementAssignment_2_11(), "rule__Requirement__SubrequirementAssignment_2_11");
					put(grammarAccess.getRequirementAccess().getDecomposesReferenceAssignment_2_12_1(), "rule__Requirement__DecomposesReferenceAssignment_2_12_1");
					put(grammarAccess.getRequirementAccess().getDecomposesReferenceAssignment_2_12_2_1(), "rule__Requirement__DecomposesReferenceAssignment_2_12_2_1");
					put(grammarAccess.getRequirementAccess().getEvolvesReferenceAssignment_2_13_1(), "rule__Requirement__EvolvesReferenceAssignment_2_13_1");
					put(grammarAccess.getRequirementAccess().getEvolvesReferenceAssignment_2_13_2_1(), "rule__Requirement__EvolvesReferenceAssignment_2_13_2_1");
					put(grammarAccess.getRequirementAccess().getStakeholderRequirementReferenceAssignment_2_14_2(), "rule__Requirement__StakeholderRequirementReferenceAssignment_2_14_2");
					put(grammarAccess.getRequirementAccess().getStakeholderRequirementReferenceAssignment_2_14_3_1(), "rule__Requirement__StakeholderRequirementReferenceAssignment_2_14_3_1");
					put(grammarAccess.getRequirementAccess().getSystemRequirementReferenceAssignment_2_15_2(), "rule__Requirement__SystemRequirementReferenceAssignment_2_15_2");
					put(grammarAccess.getRequirementAccess().getSystemRequirementReferenceAssignment_2_15_3_1(), "rule__Requirement__SystemRequirementReferenceAssignment_2_15_3_1");
					put(grammarAccess.getRequirementAccess().getVerifiedByAssignment_2_16(), "rule__Requirement__VerifiedByAssignment_2_16");
					put(grammarAccess.getRequirementAccess().getArgumentAssignment_2_17(), "rule__Requirement__ArgumentAssignment_2_17");
					put(grammarAccess.getRequirementAccess().getDocReferenceAssignment_2_18_2(), "rule__Requirement__DocReferenceAssignment_2_18_2");
					put(grammarAccess.getRequirementAccess().getDocReferenceAssignment_2_18_3_1(), "rule__Requirement__DocReferenceAssignment_2_18_3_1");
					put(grammarAccess.getRequirementAccess().getModelReferenceAssignment_2_19_1(), "rule__Requirement__ModelReferenceAssignment_2_19_1");
					put(grammarAccess.getRequirementAccess().getModelReferenceAssignment_2_19_2_1(), "rule__Requirement__ModelReferenceAssignment_2_19_2_1");
					...
					put(grammarAccess.getHazardAccess().getTargetAssignment_2_0_1(), "rule__Hazard__TargetAssignment_2_0_1");
					put(grammarAccess.getHazardAccess().getCategoryAssignment_2_1_1(), "rule__Hazard__CategoryAssignment_2_1_1");
					put(grammarAccess.getHazardAccess().getCategoryAssignment_2_1_2_1(), "rule__Hazard__CategoryAssignment_2_1_2_1");
					put(grammarAccess.getHazardAccess().getTitleAssignment_2_2_1(), "rule__Hazard__TitleAssignment_2_2_1");
					put(grammarAccess.getHazardAccess().getDescriptionAssignment_2_3_1(), "rule__Hazard__DescriptionAssignment_2_3_1");
					put(grammarAccess.getHazardAccess().getMitigatedAssignment_2_4_2(), "rule__Hazard__MitigatedAssignment_2_4_2");
					put(grammarAccess.getHazardAccess().getRationaleAssignment_2_5_1(), "rule__Hazard__RationaleAssignment_2_5_1");
					put(grammarAccess.getHazardAccess().getIssueAssignment_2_6_1(), "rule__Hazard__IssueAssignment_2_6_1");
					put(grammarAccess.getHazardAccess().getIssueAssignment_2_6_2_1(), "rule__Hazard__IssueAssignment_2_6_2_1");
					...
					put(grammarAccess.getHazardAccess().getUnorderedGroup_2(), "rule__Hazard__UnorderedGroup_2");
